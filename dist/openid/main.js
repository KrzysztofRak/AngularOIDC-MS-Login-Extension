...
var routes = [
    ...
    {
        path: 'https://mdkllgdfdjgodinoklmhfckjfkemiehp.chromiumapp.org/test',
        component: _test_test_component__WEBPACK_IMPORTED_MODULE_7__["TestComponent"]
    },
    {
        path: 'login',
...
var extensionUrl = "https://mdkllgdfdjgodinoklmhfckjfkemiehp.chromiumapp.org";
...
module.exports = "<div class=\"container\">\n  <h1>Please sign in</h1>\n  <button type=\"button\" class=\"btn btn-primary\" (click)=\"login()\">Sign in with Microsoft</button>\n</div>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, oauthService, zone) {
        this.router = router;
    ...
    LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"], angular_oauth2_oidc__WEBPACK_IMPORTED_MODULE_2__["OAuthService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["NgZone"]])
    ], LoginComponent);
...
var TestComponent = /** @class */ (function () {
    function TestComponent(http, oauthService, router) {
        var _this = this;
        this.http = http;
        this.oauthService = oauthService;
        this.router = router;
        ...
        var requestOptions = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"](headersDict)
        };
        var requestUrl = "https://graph.microsoft.com/v1.0/users/me";
        this.http.get(requestUrl, requestOptions).subscribe(function (data) {
            var userInfo = data;
            _this.displayName = userInfo.displayName;
            _this.userPrincipalName = userInfo.userPrincipalName;
        });
    }
    ...
    TestComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"], angular_oauth2_oidc__WEBPACK_IMPORTED_MODULE_2__["OAuthService"], _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"]])
    ], TestComponent);
